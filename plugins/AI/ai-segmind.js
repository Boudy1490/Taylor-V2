...
const handler = async (m, {
  ...
  try {
    ...
    switch (command) {
      case "segmindswap":
        if (!mime) return m.reply(`Masukkan gambar dan URL.\nContoh:\n*${usedPrefix}${command} [url gambar]*`);
...
handler.help = ["segmindswap", "segmindswapvid", "segmindflux", "segmindcog", "segmindrealism", "segmindimg2img", "segmindfluxdev", "segmindfluxschnell", "segmindfluxpro", "segmindillusion", "segmindclarity", "segmindvideo"];
handler.command = /^(segmindswap|segmindswapvid|segmindflux|segmindcog|segmindrealism|segmindimg2img|segmindfluxdev|segmindfluxschnell|segmindfluxpro|segmindillusion|segmindclarity|segmindvideo)$/i;
